    ...
    return (
        <form onSubmit={handleSubmit} className="animate-fade-in">
            ...
            <Card title="Datos de la Llamada">
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '6px' }}>
                    <Input id="L_Hora" label="Hora" type="time" value={formData.L_Hora} onChange={handleChange} required error={missingFieldsList.includes('L_Hora')} tooltip={tip('L_Hora')} />
                    <Input id="L_Fecha" label="Fecha" type="date" value={formData.L_Fecha} onChange={handleChange} required error={missingFieldsList.includes('L_Fecha')} tooltip={tip('L_Fecha')} />
                    <Select id="L_Resultado" label="Resultado" options={initialDropdowns['RESULTADO']} value={formData.L_Resultado} onChange={handleChange} required error={missingFieldsList.includes('L_Resultado')} tooltip={tip('L_Resultado')} />
                    <Select id="L_Duracion" label="Duración" options={initialDropdowns['RANGO_DURACION']} value={formData.L_Duracion} onChange={handleChange} required error={missingFieldsList.includes('L_Duracion')} tooltip={tip('L_Duracion')} />
                </div>
            </Card>
            ...
            <Card title="Evaluación del Orientador">
                ...
                <div className="glass-panel mobile-scroll-wrapper" style={{ padding: 'var(--card-padding)' }}>
                    <div className="mobile-min-w-800" style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) minmax(0,1fr) minmax(0,1fr) minmax(0,1fr)', gap: '6px', alignItems: 'start' }}>
                        {/* Headers */}
                        ...
                        {/* Row 2 */}
                        <Select id="O_Nivel_Ayuda_2" options={getFilteredOptions('NIVEL_AYUDA', [formData.O_Nivel_Ayuda_1])} value={formData.O_Nivel_Ayuda_2} onChange={handleChange} placeholder="Seleccionar..." disabled={!formData.O_Nivel_Ayuda_1 || isFieldNH('O_Nivel_Ayuda_2')} {...(isFieldOBL('O_Nivel_Ayuda_2') ? {required: true, error: missingFieldsList.includes('O_Nivel_Ayuda_2')} : {})} style={isFieldNH('O_Nivel_Ayuda_2') ? { opacity: 0.5, pointerEvents: 'none' } : {}} />
                        <Select id="O_Sentimientos_2" options={getFilteredOptions('SENTIMIENTOS', [formData.O_Sentimientos_1, formData.O_Sentimientos_3])} value={formData.O_Sentimientos_2} onChange={handleChange} placeholder="Seleccionar..." disabled={!formData.O_Sentimientos_1 || isFieldNH('O_Sentimientos_2')} {...(isFieldOBL('O_Sentimientos_2') ? {required: true, error: missingFieldsList.includes('O_Sentimientos_2')} : {})} style={isFieldNH('O_Sentimientos_2') ? { opacity: 0.5, pointerEvents: 'none' } : {}} />
                        <Select id="O_Actitud_Equivocada_2" options={getFilteredOptions('ACTITUD_EQUIVOCADA', [formData.O_Actitud_Equivocada_1])} value={formData.O_Actitud_Equivocada_2} onChange={handleChange} placeholder="Seleccionar..." disabled={!formData.O_Actitud_Equivocada_1 || isFieldNH('O_Actitud_Equivocada_2')} {...(isFieldOBL('O_Actitud_Equivocada_2') ? {required: true, error: missingFieldsList.includes('O_Actitud_Equivocada_2')} : {})} style={isFieldNH('O_Actitud_Equivocada_2') ? { opacity: 0.5, pointerEvents: 'none' } : {}} />
                        <Select id="O_Satisfaccion_2" options={getFilteredOptions('SATISFACCION', [formData.O_Satisfaccion_1])} value={formData.O_Satisfaccion_2} onChange={handleChange} placeholder="Seleccionar..." disabled={!formData.O_Satisfaccion_1 || isFieldNH('O_Satisfaccion_2')} {...(isFieldOBL('O_Satisfaccion_2') ? {required: true, error: missingFieldsList.includes('O_Satisfaccion_2')} : {})} style={isFieldNH('O_Satisfaccion_2') ? { opacity: 0.5, pointerEvents: 'none' } : {}} />

                        {/* Row 3 */}
                        <div></div>
                        <Select id="O_Sentimientos_3" options={getFilteredOptions('SENTIMIENTOS', [formData.O_Sentimientos_1, formData.O_Sentimientos_2])} value={formData.O_Sentimientos_3} onChange={handleChange} placeholder="Seleccionar..." disabled={!formData.O_Sentimientos_2 || isFieldNH('O_Sentimientos_3')} {...(isFieldOBL('O_Sentimientos_3') ? {required: true, error: missingFieldsList.includes('O_Sentimientos_3')} : {})} style={isFieldNH('O_Sentimientos_3') ? { opacity: 0.5, pointerEvents: 'none' } : {}} />
                        <div></div>
                        <div></div>
                    </div>
                </div>
