...
const INITIAL_LISTS = {
    ...
    "EDAD": [
        ...
        { value: "5", label: "5 - De 46 a 55", active: true },
        { value: "6", label: "6 - De 56 a 65", active: true },
    ...
    "PRESENTACION": [
        ...
        { value: "4", label: "4 - Abstracta e impersonal", active: true },
        ...
        { value: "10", label: "10 - Comunicación Incongruente", active: true }
    ],
    "PARALENGUAJE": [
    ...
    "NIVEL_AYUDA": [
        ...
        { value: "3", label: "3 - Acción desangustiante", active: true },
        { value: "4", label: "4 - Comprensión empática", active: true },
        { value: "5", label: "5 - Reestructuración del problema", active: true },
    ...
    "RANGO_DURACION": [
        { value: "1", label: "1 - 1-5 min", active: true },
        { value: "2", label: "2 - 6-10 min", active: true },
        { value: "3", label: "3 - 11-20 min", active: true },
        { value: "4", label: "4 - 21-30 min", active: true },
        { value: "5", label: "5 - +30 min", active: true }
    ],
    "VOLVERA_LLAMAR": [
    ...
    "PROBLEMATICA": [
        { value: "A", label: "A - PROBLEMAS PSICOLÓGICOS Y PSIQUIÁTRICOS", active: true },
        { value: "B", label: "B - PROBLEMAS FAMILIARES", active: true },
        { value: "C", label: "C - PROBLEMAS DE LA VIVIENDA", active: true },
        { value: "D", label: "D - PROBLEMAS RELACIONADOS CON EL DINERO Y EL TRABAJO", active: true },
        { value: "E", label: "E - PROBLEMAS DE SALUD", active: true },
        { value: "F", label: "F - PROBLEMAS RELACIONADOS CON LA VIOLENCIA", active: true },
        { value: "G", label: "G - PROBLEMAS DE JUSTICIA", active: true },
        { value: "H", label: "H - PROBLEMAS SOCIALES", active: true },
        { value: "I", label: "I - PROBLEMAS DE RECURSOS", active: true },
        { value: "J", label: "J - PROBLEMAS POR CATASTROFES", active: true },
        { value: "K", label: "K - PROBLEMAS POR PROCESOS EVOLUTIVOS", active: true },
        { value: "L", label: "L - PROBLEMAS POR ABUSO SEXUAL", active: true },
        { value: "M", label: "M - PROBLEMAS RELACIONADOS CON LA VIOLENCIA DOMÉSTICA", active: true },
        { value: "N", label: "N - PROBLEMAS RELACIONADOS CON EL ACOSO (STALKING)", active: true },
        { value: "O", label: "O - PROBLEMAS RELACIONADOS CON LAS DISCAPACIDADES", active: true },
        { value: "P", label: "P - LLAMADAS PERIFÉRICAS", active: true },
        { value: "Q", label: "Q - PROBLEMAS DE CONDUCTAS ADICTIVAS", active: true },
        { value: "R", label: "R - PROBLEMAS DE SALUD MENTAL EN FAMILIARES", active: true }
    ],
    "PROBLEMA": [
        { value: "A1", label: "A1 - Crisis en el proyecto vital", active: true }
    ]
};
